...
namespace BlockchainCore.Utilities
{
    public static class HexByteUtility
    {
        ...
        public static string ToHex(this Span<byte> byteArray)
        {
            StringBuilder builder = new StringBuilder();

            for (int i = 0; i < byteArray.Length; i++)
            {
                builder.Append(byteArray[i].ToString("x2")); //convert to Hex
            }
